            ...
            <Result visible={result.visible} onClose={close}>
                ...
                {result.output && (
                    <Descriptions
                        ...
                        layout="vertical"
                    >
                        <Descriptions.Item label="Sph A + B">
                            {result.output.sph1add2}
                        </Descriptions.Item>
                        <Descriptions.Item label="Cyl A + B">
                            {result.output.cyl1add2}
                        </Descriptions.Item>
                        <Descriptions.Item label="Axis A + B">
                            {result.output.axis1add2}
                        </Descriptions.Item>
                        <Descriptions.Item label="Sph A - B">
                            {result.output.sph1cut2}
                        </Descriptions.Item>
                        <Descriptions.Item label="Cyl A - B">
                            {result.output.cyl1cut2}
                        </Descriptions.Item>
                        <Descriptions.Item label="Axis A - B">
                            {result.output.axis1cut2}
                        </Descriptions.Item>
                    </Descriptions>
                )}
                <div>
