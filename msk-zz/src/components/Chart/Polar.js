...
export default function Polar({
    ...
    useEffect(() => {
        ...
        current.g = current.chart
            .append("g")
            .attr("transform", `translate(${width / 2}, ${height / 2})`);
        current.legend = current.chart.append("g").attr("transform", `translate(${width}, 10)`);
        ...
        current.g
            ...
            .attr("marker-end", (d) => {
                ...
                const arrowMarker = current.defs
                    ...
                    .attr("orient", "auto");
                arrowMarker.append("path").attr("d", "M0,-5 L10,0 L0,5").attr("fill", color(d));
                return `url(#${id})`;
            });
    }, [type, data]);
