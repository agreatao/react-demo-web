...
export default function ioltoric() {
    const intl = useIntl();
    ...
    return [
        <h1 key="title" className="title">
            <FormattedMessage id="calc.iol.toric.name" />
        </h1>,
        <Spin key="collapse" spinning={loading}>
            <Collapse ghost activeKey={activeKey} onChange={onActiveChange}>
                <Panel key="instructions" header={<FormattedMessage id="tip.title.instructions" />}>
                    <FormattedMessage id="calc.iol.toric.instructions" />
                </Panel>
                <Panel key="notes" header={<FormattedMessage id="tip.title.notes" />}>
                    <FormattedMessage id="calc.iol.toric.notes" />
                </Panel>
                <Panel key="input" header={<FormattedMessage id="text.input" />}>
                    ...
                    >
                        <Row gutter={24}>
                            ...
                            <Col {...layout}>
                                <Form.Item label="SIA (D)" name="sia" rules={[{ required: true }]}>
                                    <Input autoComplete="off" />
                                </Form.Item>
                            </Col>
                            <Col {...layout}>
