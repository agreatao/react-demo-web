                    ...
                    <Form className="tab-page check-form" style={{ height: height - 166 }}>
                        <Form.Item {...layout} label="报告类型">
                            {edit ? getFieldDecorator("reportType", {
                                ...
                                <Select>
                                    {specialReportType.map((item, index) => <Option key={index} value={item.value}>{item.text}</Option>)}
                                </Select>
                        ...
                        <Form.Item {...layout} label="主治医生">
                            {edit ? getFieldDecorator("doctorId", {
                                ...
                                <Select>
                                    {doctors && doctors.map((item, index) => <Option key={index} value={item.id}>{item.nickName}</Option>)}
                                </Select>
                        ...
                        <Form.Item {...layout} label="检查设备">
                            {edit ? getFieldDecorator("checkEquipment", {
                        ...
                        <Form.Item {...layout} label="医学影像">
                            {edit ? getFieldDecorator("image")(
                                <Upload
                                    ...
                                    action={CONFIG.baseURL + "/sick/imageUpload?sickInfoId=" + this.props.dataKey}
                                    beforeUpload={file => {
                                        const isJpgOrPng =
                        ...
                        <div className="tab-page">
                            <div className="btn-group">
                                <Button type="primary" onClick={e => this.setState({ data: {}, edit: true })}>添加特检报告</Button>
                            </div>
                        </div>
                    );
            }
