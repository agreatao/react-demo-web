                    ...
                    <Table
                        ...
                        columns={[
                            ...
                            },
                            {
                                ...
                                dataIndex: "roleId",
                                width: 200,
                                render: (roleId) => roleId == 1 ? "管理员" : roleId == 2 ? "医生" : "护士"
                            },
                            {
                                title: "操作",
                                className: "actions",
            ...
            return (
                <Form className="medicine-filter" layout="inline" onSubmit={this.handleSubmit}>
                    <Row gutter={24}>
                        <Col span={18}>
                            <Form.Item label="姓名">
                                {getFieldDecorator("nickName")(<Input autoComplete="off" />)}
                            </Form.Item>
                            <Form.Item label="手机号码">
                                {getFieldDecorator("telephone")(<Input autoComplete="off" />)}
                            </Form.Item>
                            <Form.Item label="职级">
                                {getFieldDecorator("roleId")(<Select style={{ width: 200 }}>
